// src/Frontend/pages/HRSalaries.jsx
          ...
          <div className="max-w-7xl mx-auto">
            <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-8">
              <div className="text-center">
                <h2 className="text-lg font-semibold text-gray-800 mb-4">Salary Administration</h2>
                <p className="text-gray-600">This section will contain salary CRUD operations.</p>
